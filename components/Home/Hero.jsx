...
export default function Hero() {
  return (
    <section className="md:my-5 bg-gray-100 p-6 md:p-10 rounded-xl flex flex-col md:flex-row items-center justify-center gap-6 md:gap-10 lg:gap-20 overflow-hidden">
